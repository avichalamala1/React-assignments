...
function Products() {
    ...
    function addProduct()
    {
      ...
      // console.log(deptObj);
      axios.post(`http://localhost:3000/products`, prodObj).then( (resData) => {          
    ...
    {
      axios.get(`http://localhost:3000/products/`+pno).then( 
          resData => 
          {
    ...
    function updateProduct()
    {
      ...
      axios.put(`http://localhost:3000/products/`+id,prodObj).then( resData => {
        getData();
    ...
    function removeProd(pno)
    {
      ...
      {
        axios.delete(`http://localhost:3000/products/`+pno).then( resData => 
          {
